...
alias gcc='gcc -std=c14   -pedantic -Wall -Wextra -Wcast-align -Wcast-qual -Wstrict-aliasing -Wpointer-arith -Wfloat-equal -Wshadow -Wformat -Wwrite-strings'
alias g++='g++ -std=c++14 -pedantic -Wall -Wextra -Wcast-align -Wcast-qual -Wstrict-aliasing -Wpointer-arith -Wfloat-equal -Wshadow -Wformat -Wwrite-strings -Weffc++ -Woverloaded-virtual'
alias clang='clang     -std=c14   -pedantic -Weverything -Wall -Wextra -Wcast-align -Wcast-qual -Wstrict-aliasing -Wpointer-arith -Wshadow -Wformat -Wwrite-strings -Weffc++ -Woverloaded-virtual'
alias clang++='clang++ -std=c++14 -pedantic -Weverything -Wall -Wextra -Wcast-align -Wcast-qual -Wstrict-aliasing -Wpointer-arith -Wshadow -Wformat -Wwrite-strings -Weffc++ -Woverloaded-virtual -stdlib=libc++ -lc++abi'
